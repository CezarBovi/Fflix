...
const rateLimiter_1 = require("../../../../shared/infrastructure/middlewares/rateLimiter");
...
exports.authRoutes.post('/login', rateLimiter_1.loginRateLimiter, (0, safeHandler_1.safeHandler)(controller.login));
